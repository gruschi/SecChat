...
public class SCConstants {
     ...
     public static final String REST_CONNECT_FRIEND = REST_SERVER + "/SecChat/connect/contact";
     public static final String REST_CONNECT_GROUP = REST_SERVER + "/SecChat/connect/group";     
